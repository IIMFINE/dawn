...
int PosixRobustMutex::lock() { return pthread_mutex_lock(&mutex_); }

void PosixRobustMutex::unlock() { pthread_mutex_unlock(&mutex_); }

int PosixRobustMutex::tryLock() { return pthread_mutex_trylock(&mutex_); }
