...
#define _GET_PARENT_INDEX(index) ((index - 1) / 2)
  ...
  MaxHeap<KEY_T, CONTENT_T, COMPARATOR>::MaxHeap(const MaxHeap &heap) :
  ...
  template <typename KEY_T, typename CONTENT_T, typename COMPARATOR>
  MaxHeap<KEY_T, CONTENT_T, COMPARATOR>::MaxHeap(MaxHeap &&heap) :
    MinixHeap<KEY_T, CONTENT_T>()
  {
  ...
  template <typename KEY_T, typename CONTENT_T, typename COMPARATOR>
  MinHeap<KEY_T, CONTENT_T, COMPARATOR>::MinHeap(const MinHeap &heap) :
    MinixHeap<KEY_T, CONTENT_T>()
  {
    this->heap_ = heap.heap_;
    this->heap_size_ = heap.heap_size_;
  ...
  template <typename KEY_T, typename CONTENT_T, typename COMPARATOR>
  MinHeap<KEY_T, CONTENT_T, COMPARATOR>::MinHeap(MinHeap &&heap) :
    MinixHeap<KEY_T, CONTENT_T>()
  {
    this->heap_ = std::move(heap.heap_);
    this->heap_size_ = heap.heap_size_;
